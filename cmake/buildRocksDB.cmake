macro(buildRocksDB)
  ...
  ExternalProject_Add(BuildRocksDB
    ...
    CONFIGURE_COMMAND ""
    BUILD_IN_SOURCE 1
    BUILD_COMMAND bash -c "export PORTABLE=1 && export DISABLE_JEMALLOC=1 && export OPT='-fPIC -DNDEBUG -O3' && export USE_RTTI=1 && make static_lib -j $(cat /proc/cpuinfo | grep 'processor' | wc -l)"
    INSTALL_COMMAND ""
  )
