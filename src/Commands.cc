...
struct cmdMapInit {
  cmdMapInit() {
    ...
    redis_cmd_map["raft_demote_to_observer"] = {RedisCommand::RAFT_DEMOTE_TO_OBSERVER, CommandType::RAFT};
    ...
    redis_cmd_map["quarkdb_verify_checksum"] = {RedisCommand::QUARKDB_VERIFY_CHECKSUM, CommandType::QUARKDB};
